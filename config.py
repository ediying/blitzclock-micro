...
base_url_text = f'http://{blockclock_ip}/api/show/text/'
send_tick_sound = f'http://{blockclock_ip}/api/action/sound?demo'
send_light_on = f'http://{blockclock_ip}/api/lights/'
send_light_off =  f'http://{blockclock_ip}/api/lights/off'
light_color_orange = 'FD9100'
